...
import mainphoto from "../../assets/berita/3.1.png";
  ...
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      <h2 className="text-[40px] font-semibold text-center text-black mb-8">
        Potensi Ekonomi Sarang Burung Walet
      </h2>
      ...
      <div className="prose prose-lg max-w-fit mx-auto text-xl text-justify mb-16 mt-20 text-black leading-relaxed border-b-[3px] pb-[40px] border-border">
        <p>
          Di tengah tingginya nilai ekspor kebutuhan sarang burung walet di
          tingkat global sekaligus menjadi pemasok terbesar sarang burung walet
          ke China, tidak semua masyarakat Indonesia mengetahui cara budidaya
          dan manfaat dari konsumsi sarang burung walet tersebut. Padahal,
          budidaya sarang burung walet dapat menjadi primadona andalan di sektor
          agribisnis dengan keuntungan yang menjanjikan. 
        </p>
        <br />
        <p>
          Sebab, untuk satu kilogram harga sarang burung walet dijual dengan
          harga rata-rata Rp7-10 juta per kilogram. Dilansir dari SINDOnews.com,
          volume ekspor sarang burung Indonesia pada tahun 2023 mencapai 1.335
          ton dengan nilai US$ 633,25 juta atau setara dengan Rp 9,81 triliun
          (US$ 1= 15.945). Dengan menggunakan hitungan dolar AS saat ini, maka 1
          kg sarang burung Indonesia dihargai mencapai Rp 7,35 juta.
        </p>
        <br />
        <p>
          Di Indonesia sendiri, baru di daerah Kalimantan dan Sumatera yang
          memiliki banyak petani yang beralih menjadi pembudidaya sarang burung
          walet cukup dengan modal awal membangun rumah walet dari bahan
          sederhana. Poin utama dari investasi bisnis budidaya sarang walet ini
          cukup membangun gedung atau rumah sarang walet. Dengan mengandalkan
          jumlah modal, banyak pembudidaya pemula yang membangun gedung sarang
          walet dengan biaya 100 hingga 200 juta rupiah, namun ada juga yang
          hanya mengandalkan rumah papan ukuran 4×4 atau 4×6 meter persegi,
          dengan catatan suhu dan kelembaban terjaga.
        </p>
        <br />
        <p>
          Nilai realisasi ekspor komoditi sarang burung walet asal Sumatera
          Utara (Sumut) mencapai hampir Rp1 triliun pada tahun 2021. Capaian itu
          menempatkan Sumut sebagai daerah pengekspor sarang burung walet
        ...
        <p className="text-black font-bold mt-6">
          ...
          <br />
          <a
            href="https://www.konteks.co.id/ekonomi/294916/indonesia-raja-sarang-burung-walet-potensi-ekspornya-bikin-ngiler-negara-lain/ "
            target="_blank"
            rel="noopener noreferrer"
            className="text-iconig font-normal ml-1"
          >
            https://www.konteks.co.id/ekonomi/294916/indonesia-raja-sarang-burung-walet-potensi-ekspornya-bikin-ngiler-negara-lain/
          </a>
        </p>
      </div>
