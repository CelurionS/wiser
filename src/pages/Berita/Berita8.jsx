...
import mainphoto from "../../assets/berita/8.1.png";
...
const Berita8 = () => {
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      Peluang dan Tantangan Peternakan Burung Walet di Daerah Perkotaan: Menguntungkan, tetapi Tidak Tanpa Hambatan
      </h2>
...
<div className="prose prose-lg max-w-fit mx-auto text-xl text-justify mb-16 mt-20 text-black leading-relaxed border-b-[3px] pb-[40px] border-border">
  <p>
  Peternakan burung walet kini mulai merambah daerah perkotaan, didorong oleh tingginya permintaan global akan sarang burung walet, terutama dari Tiongkok. Banyak pengusaha memanfaatkan gedung-gedung kosong sebagai rumah burung walet, karena infrastruktur dan akses pasar yang lebih mudah di kota. Namun, peluang bisnis ini dihadapkan dengan berbagai tantangan.
  </p>
  <br />
  <p>
  Regulasi pemerintah sering kali belum jelas terkait peternakan burung walet di wilayah urban, sementara proses perizinan bisa menjadi rumit dan memakan waktu. Di sisi lain protes warga muncul karena suara bising burung walet dan kekhawatiran akan masalah kesehatan, menciptakan konflik dengan pelaku usaha. Dampak lingkungan juga menjadi perhatian, dengan kekhawatiran terhadap perubahan ekosistem lokal dan potensi pencemaran. Meskipun peternakan burung walet di kota menjanjikan keuntungan besar, pelaku usaha perlu memperhatikan regulasi, kesejahteraan warga, dan dampak lingkungan untuk memastikan keberlanjutan industri ini.
  </p>
