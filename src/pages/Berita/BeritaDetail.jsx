  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-[40px] font-semibold text-center text-black mb-8">
        {berita.title || "Juudl Tidak Tersedia"}
      </h2>
      ...
      {/* Content */}
      <div
        className="prose prose-lg max-w-fit mx-auto text-xl text-justify mb-16 mt-20 text-black leading-relaxed border-b-[3px] pb-[40px] border-border"
