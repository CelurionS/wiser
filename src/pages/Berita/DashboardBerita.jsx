  ...
  useEffect(() => {
    const fetchBerita = async () => {
      try {
        ...
        setBeritaData(data);
        setFilteredGridData(data); // Default grid adalah semua berita
      } catch (error) {
      ...
      <div className="flex flex-col lg:flex-row gap-12 mb-16">
        ...
        {beritaMain && (
          <div
            ...
            onClick={() => handleNavigate(`/berita/${beritaMain.id}`)}
          >
            <img
        ...
        <div className="flex flex-col w-full lg:w-1/3 gap-4">
          {sideBeritaData.map((item) => (
            <div
              ...
              onClick={() => handleNavigate(`/berita/${item.id}`)}
            >
              <img
                src={item.mainPhoto}
                alt={item.title}
  ...
  {smallArticles.map((item) => (
    ...
    >
      ...
      <div className="text-balance">
        ...
        <p className="text-xl text-black mt-3">oleh {item.author} / {item.date}</p>
