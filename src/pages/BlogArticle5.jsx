...
import mainphoto from "../assets/blog-article/5.1.png";
  ...
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      <h2 className="text-[40px] font-semibold text-center text-black mb-8">
        Jenis Parfum Aroma Walet Yang Digunakan Peternak Walet
      </h2>
      ...
      <div className="prose prose-lg max-w-fit text-xl text-justify mb-16 mt-20 text-black leading-relaxed">
        <p>
          Untuk mengoptimalkan budidaya sarang burung walet banyak cara yang
          dilakukan oleh peternak walet salah satunya adalah menggunakan parfum
          atau aroma khusus percaya mampu meningkatkan perkembangan populasi
          burung walet. Parfum walet atau aroma khusus pemikat walet diyakini
          memiliki fungsi membentuk koloni dan mempertahankan walet yang telah
          terpancing oleh suara panggi. Parfum walet memiliki banyak jenis dan
          variasi. Terdapat jenis parfum walet yang diproduksi dalam skala besar
          dan diperjualbelikan oleh pabrik maupun home made dan ada juga parfum
          walet diolah sendiri oleh peternak walet menggunakan bahan yang mudah
          didapaatkan.
        </p>
        <br />
        <p>
          Di pasaran terdapat macam-macam merek aroma pemikat walet yang dapat
          kita beli di toko perlengkapan burung walet. Selain itu terdapat
          beberapa jenis parfum walet yang berbeda cara penggunaannya serta
          manfaat yang berbeda pula. Berikut adalah parfum walet yang biasa
          digunakan di kalangan budidaya burung walet.
        </p>
        <br />

        <div>
          <h4 className="font-bold">1.Parfum sirip</h4>
          <p>
            Parfum sirip merupakan aroma yang digunakan atau diaplikasikan pada
            sirip tempat di mana walet tinggal dan bersarang. Penggunaanya
            adalah dengan cara menyemprotkan atau mengoleskannya pada sirip
            dengan volume tertentu dan dengan kadar yang sesuai. Parfum sirip
            mampu memikat anakan walet agar betah berada di dalam ruang inap.
            Selain itu parfum sirip juga merangsang walet dewasa agar terus
            membuat sarang dengan kualitas yang baik. Penggunaan parfum ini
            harus berhati-hati, karena jika tidak justru akan menimbulkan efek
            yang buruk seperti jamur, sirip berdebu dan berbau menyengat.
          </p>
        </div>
        <br />

        <div>
          <h4 className="font-bold">2. Parfum dinding</h4>
          <p>
            Berbeda dengan parfum sirip parfum dinding digunakan dengan tujuan
            untuk menciptakan ruangan inap seperti ruangan yang telah memiliki
            koloni walet yang banyak, mirip pada goa-goa alami. Penggunaan
            parfum ini ditujukan agar Walet merasa bahwa di ruangan tersebut
            sudah lama didiami koloni walet. Parfum jenis ini biasanya digunakan
            pada gedung-gedung baru sebagai upaya menghilangkan bau semen, bau
            kayu,dan  bau dari bahan bahan material yang digunakan dalam
            pembangunan. Cara menggunakan parfum ini adalah dengan menyemprotkan
            atau mengoleskannya pada dinding ruangan inap dan ruang terjun rumah
            burung walet. Penggunaan parfum ini juga harus sesuai dengan kadar
            dan jumlah yang standard. Agar tidak terjadi efek buruk bagi ruangan
            pada rumah burung walet, seperti bau menyengat sehingga membuat
            walet enggan mendekat.
          </p>
        </div>
        <br />

        <div>
          <h4 className="font-bold">3. Parfum ruangan</h4>
          <p>
            Parfum jenis ini biasanya berupa cairan aerosol yang dicampur dengan
            oksigen yang dikemas dalam kaleng semprot. Penggunaan parfum ini
            tidak dioles tetapi disemprot padang area ruangan inap. Beberapa
            peternak walet menggunakan alat tambahan berupa dispenser agar dapat
            menggunakan parfum ini terus menerus dengan waktu penyemprotan yang
            bisa ditentukan. Parfum jenis ini biasanya digunakan peternak
            setelah selesai memanen sarang burung walet, dengan tujuan untuk
            menghindari stres pada burung walet akibat pemetikan sarang.
          </p>
        </div>
        <br />
        ...
        <div>
          <p>
            Penggunaan parfum atau aroma pemikat memang sangat bagus dalam
            memikat burung walet agar mampu perkembang dalam rumah burung walet.
            Namun kita harus jeli memilih parfum mana yang memiliki kualitas
            baik atau tidak. Agar terhindar dari efek samping yang justru dapat
            menurunkan produktivitas dan perkembangan sarang burung walet
          </p>
        </div>
        <br />
        ...
        <p className="text-black font-bold mt-6">
          ...
          <br />
          <a
            href="https://www.dianwalet.com/2019/09/jenis-jenis-parfum-aroma-walet-yang.html"
            target="_blank"
            rel="noopener noreferrer"
            className="text-iconig font-normal ml-1"
          >
            Jenis-Jenis Parfum Aroma Walet Yang Digunakan Peternak Walet | DIAN
            WALET
          </a>
        </p>
      </div>
