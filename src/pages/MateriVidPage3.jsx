...
const MateriVidPage3 = () => {
  const navigate = useNavigate(); // Initialize navigate for routing
  const [mainVideo, setMainVideo] = useState({
    title: 'Design Gedung Walet',
    videoUrl: 'https://www.youtube.com/embed/8ar7TAI4p4M',
  ...
  const otherVideos = [
    {
      ...
      videoUrl: 'https://www.youtube.com/embed/-_d5dxD3wAM',
      Duration: '18 menit',
    },
    {
      image: MdWallet3,
      ...
      videoUrl: 'https://www.youtube.com/embed/-0lDx5PK7yE',
      Duration: '8 menit',
    },
  ];
