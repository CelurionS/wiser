...
const EdukasiPage = () => {
  const materials = [
    { id: 1, title: "Pengenalan Burung Walet dan Habitatnya", image: m1, link: "/MateriDetailpage1" },
    { id: 2, title: "Pemilihan Lokasi Rumah Walet", image: m2, link: "/MateriDetailpage2" },
    { id: 3, title: "Desain dan Konstruksi Rumah Walet", image: m3, link: "/MateriDetailpage3" },
  ];
  ...
  return (
    <div>
      ...
      >
        <div className="flex flex-col space-y-6 mt-[50px] pl-[50px] pr-[50px] w-full sm:w-1/2 items-start">
          ...
          <div className="flex space-x-[30px]">
            <Link to="/MateriPage">
              <button className="w-[150px] h-[44px] bg-[#246AA4] text-white rounded-md flex items-center justify-center">
                <span className="text-base">Materi</span>
              </button>
            </Link>
            <Link to="/">
              <button className="w-[150px] h-[44px] bg-[#246AA4] text-white rounded-md flex items-center justify-center">
                <span className="text-base">Blog Dialog</span>
              </button>
            </Link>
            <Link to="/">
              <button className="w-[150px] h-[44px] bg-[#246AA4] text-white rounded-md flex items-center justify-center">
      ...
      <section className="mt-12 p-12">
        ...
        <div className="flex justify-between gap-[40px] pl-[50px]">
      ...
      <section className="mt-12 p-12">
        ...
        <div className="flex flex-col space-y-12 pl-[50px]">
     ...
     {/* Section 4: Berita */}
      <section className="mt-12 p-12">
        ...
        <div className="relative w-full max-w-[1040px] mx-auto overflow-hidden rounded-lg shadow-lg">
          {/* Kontainer Berita */}
          <div
          ...
          >
            {berita.map((item) => (
              <Link
                key={item.id}
                to={`/berita/${item.id}`}
                className="flex-shrink-0 w-full max-w-[1040px] bg-white p-6 rounded-lg shadow-md"
              >
                <div className="flex flex-col md:flex-row items-center">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="w-full md:w-[40%] h-auto object-cover rounded-lg mb-4 md:mb-0"
                  />
