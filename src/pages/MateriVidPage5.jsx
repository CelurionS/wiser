...
const MateriVidPage5 = () => {
  const navigate = useNavigate(); // Initialize navigate for routing
  const [mainVideo, setMainVideo] = useState({
    title: 'Cara Menentukan Suara Panggil Walet',
    videoUrl: 'https://www.youtube.com/embed/GVC5-B4TNVM',
    description: 'Suara panggil walet memiliki kriteria tertentu yang perlu diperhatikan untuk menarik burung walet masuk ke gedung. Suara yang baik bukan hanya jernih, tetapi juga khusus, sehingga mampu mengundang burung walet mendekati sumber suara.',
    Duration: '10 menit',
    image: Mwallet1,
  });
  ...
  const otherVideos = [
    {
      ...
      videoUrl: 'https://www.youtube.com/embed/qL8WuTSFnE0',
      Duration: '5 menit',
    },
  ];
