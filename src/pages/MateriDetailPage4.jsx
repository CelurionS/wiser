...
const MateriDetailPage4 = () => {
  ...
  const cardsData = [
    { 
      ...
      Duration: '9 menit', 
      pageUrl: '/MateriVidPage4' 
    },
    { 
      image: MdWallet3, 
      title: 'Cara Mengatur Suhu dan Kelembapan Agar Tetap Stabil', 
      description: 'Cara Mengatur Suhu dan Kelembapan Agar Tetap Stabil', 
      Duration: '10 menit',
      pageUrl: '/MateriVidPage4' 
    },
    { 
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white pt-16 font-railway">
      ...
      {/* Section Header */}
      <div className="text-center w-full p-9">
        <h2 className="text-3xl font-semibold text-black font-railway">Pengaturan Suhu dan Kelembapan</h2>
      </div>
...
export default MateriDetailPage4;
