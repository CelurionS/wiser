...
import VideoCard from "../component/VideoCardDetail"; // Pastikan path ini benar
import defaultVideoImage from "/assets/materi/images/materi_1/main.png"; // Pastikan path ini benar
          ...
          <div className="grid grid-cols-1 gap-5 justify-center max-w-[1040px] mx-auto">
            {filteredOtherVideos.map((video) => (
              <VideoCard
                ...
                link={`/materivideo/${id}?video=${video.id}`} // Tambahkan query parameter
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {relatedMateri.map((item) => (
          <div
            ...
            onClick={() => navigate(`/materi/${item.id}`)} // Pastikan routing sesuai
          >
            <img
              src={
