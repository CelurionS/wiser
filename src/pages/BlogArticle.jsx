...
import mainphoto from "../assets/blog-article/1.1.png";
import secondaryPhoto1 from "../assets/blog-article/1.2.png";
    ...
    <div className="container mx-auto px-4 py-8 ">
      ...
      <div className="prose prose-lg max-w-fit text-xl text-justify mb-16 mt-20 text-black">
        <p>
          ...
          unicolour) melalui air liur yang diproduksi oleh kelenjar di bawah
          lidah. Sarang ini memiliki permintaan tinggi di pasar internasional,
          terutama di Cina, karena dianggap bermanfaat untuk kesehatan dan
          digunakan dalam pengobatan serta masakan Cina. Sarang burung walet
          dari Indonesia unggul dengan kandungan protein yang tinggi
          (59,8-65,8%), tergantung pada asal geografis, sumber makanan, dan
          spesies burung. Kualitas sarang yang tinggi ini menjadikan produk ini
          sangat dihargai, meskipun produksi sarang burung walet ini memerlukan
          kondisi yang sangat spesifik, seperti suhu, kelembapan, dan keberadaan
          sumber makanan yang sesuai untuk burung walet.
        </p>
        ...
        <div className="flex flex-col md:flex-row gap-6 my-8 items-center">
          ...
          <p className="text-black md:w-1/2 lg:w-5/12 lg:ml-8 h-auto">
            Namun, sarang burung walet dapat terkontaminasi nitrit, yang
            berbahaya karena dapat menyebabkan methemoglobinemia (gangguan
            aliran oksigen) dan meningkatkan risiko kanker kolorektal. Nitrit
            terbentuk secara alami di habitat burung walet, ketika amoniak dari
            kotoran burung berubah menjadi nitrit melalui oksidasi. Hal ini
            menjadi perhatian utama bagi para produsen dan konsumen sarang
            burung walet, karena paparan nitrit dalam kadar tinggi dapat
            menimbulkan efek kesehatan yang serius. Badan Karantina Pertanian
            telah menetapkan batas maksimal kandungan nitrit pada sarang burung
            walet sebesar 30 ppm, sebagai langkah pencegahan terhadap potensi
            dampak kesehatan yang ditimbulkan. Kajian lebih lanjut diperlukan
            untuk memahami proses nitrifikasi yang terjadi di sarang walet,
            terutama terkait peran bakteri nitrifikasi yang mengubah nitrat
            menjadi nitrit.
          </p>
        </div>

        <p>
          Sarang burung walet sering mengandung nitrit, senyawa beracun yang
          bisa berbahaya jika dikonsumsi dalam jumlah tinggi. Penelitian di
          Pasar Hongkong menunjukkan variasi kandungan nitrit antara 0-6430 ppm,
          dengan median 100 ppm. Sarang dari Indonesia, sebelum pencucian,
          umumnya mengandung nitrit dalam kisaran rendah hingga sedang
          (1,42-93,12 ppm), yang bisa menurun dengan pencucian hingga 30,87 ppm
          setelah tiga kali pencucian. Nitrit yang tinggi dapat menyebabkan
          masalah kesehatan serius, seperti gangguan pencernaan, keracunan,
          bahkan kematian, terutama pada bayi karena risiko methemoglobinemia,
          yaitu kekurangan oksigen dalam darah.
        </p>
        <p>
          Kandungan nitrit pada sarang burung walet dipengaruhi oleh kebersihan
          lingkungan rumah walet, yang bisa terkontaminasi dari pembusukan
          material organik. Nitrit dapat terbentuk secara alami dari oksidasi
          natrium nitrat atau melalui aktivitas bakteri. Nitrit juga bisa memicu
          pembentukan N-nitrosamin, senyawa karsinogenik yang dikaitkan dengan
