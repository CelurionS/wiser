...
const MateriVidPage4 = () => {
  const navigate = useNavigate(); // Initialize navigate for routing
  const [mainVideo, setMainVideo] = useState({
    title: 'Jam Pengukuran Suhu dan Kelembapan Rumah Burung Walet yang Tepat',
    videoUrl: 'https://www.youtube.com/embed/7sMtjQuOq3A',
    description: 'Panduan ini memberikan langkah-langkah dalam membuat rumah walet yang baik, mulai dari bahan yang dibutuhkan.',
    Duration: '9 menit',
    image: Mwallet1,
  });
  ...
  const otherVideos = [
    {
      image: MdWallet2,
      title: 'Panduan praktis ini menjelaskan cara menjaga suhu dan kelembapan yang stabil dalam rumah walet.',
      videoUrl: 'https://www.youtube.com/embed/dvkGH8_ptFE',
      Duration: '10 menit',
    },
    {
      image: MdWallet3,
      title: 'Cara Menurunkan Suhu dan Menjaga Kelembapan Pada Rumah Burung Walet',
      description: 'Panduan ini mengulas metode untuk menurunkan suhu dan mempertahankan kelembapan di rumah burung walet, dengan berbagai tips untuk menciptakan lingkungan yang ideal demi mendukung kenyamanan dan produktivitas burung walet.',
      videoUrl: 'https://www.youtube.com/embed/uZ6xlSE5gLg',
      Duration: '3 menit',
    },
  ];
