...
import mainphoto from "../assets/blog-article/6.1.png";
  ...
  return (
    <div className="container mx-auto px-4 py-8 ">
      ...
      <h2 className="text-[40px] font-semibold text-center text-black mb-8">
        Penghambat Perkembangan Rumah Burung Walet
      </h2>
      ...
      <div className="prose prose-lg max-w-fit text-xl text-justify mb-16 mt-20 text-black leading-relaxed">
        <p>
          Dalam usaha budidaya sarang burung walet tidak sedikit peternak walet
          yang mengeluhkan bahwa gedungnya kurang optimal. Jumlah populasi walet
          sulit berkembang singga sarang yang ada di dalamnya pun tidak cepat
          bertambah. Hal ini tentu membuat keresahan bagi peternak walet karena
          jika dibiarkan terus-menerus maka usaha tersebut dapat dikatakan tidak
          membuahkan hasil walaupun sebatas balik modal.
        </p>
        <br />
        <p>
          Perkembangan walet yang lambat di suatu gedung perlu dicermati dengan
          seksama. Kita tidak bisa langsung menyalahkan konsep bangunan RBW yang
          salah. Karena bisa saja lambatnya perkembangantersebut tersebut
          dipengaruhi faktor lain yang mungkin kemampuan kita dalam merubah
          hanya terbatas. Seperti faktor-faktor yang disebabkan dari alam.
          Itulah mengapa pentingnya memperhatikan kondisi wilayah tol lokasi lu
          membangun rumah burung wallet.
        </p>
        <br />
        <p>
          Berikut adalah beberapa penyebab lambat nya perkembangan pada rumah
          burung walet
        </p>
        <br />
        ...
        <div>
          <h4 className="font-bold">
            1. Kualitas suara walet yang kurang baik
          </h4>
          <p>
            Keberhasilan budidaya walet ditentukan oleh kualitas suara walet
            yang baik. Suara pemanggil walet harus benar-benar memiliki karakter
            yang mampu menarik koloni walet khususnya walet walet anakan dan
            walet betina karena dua kategori walet inilah yang menjadi cikal
            bakal generasi walet dalam gedung. Selain itu suara panggil walet
            harus terbebas dari suara walet stres dan memiliki kualitas yang
            jernih bening serta bebas dari noise. Tidak hanya suara panggil
            suara inap pun perlu diprioritaskan. Suara inap harus benar-benar
            mampu mempertahankan anakan walet yang sudah masuk ke dalam ruang
            inap. Itulah mengapa pakailah suara walet dengan kualitas yang baik.
          </p>
        </div>
        <br />

        <div>
          <h4 className="font-bold">2. Konsep tata ruang yang salah</h4>
          <p>
            Selain suara walet tata ruang juga sangat mempengaruhi perkembangan
            bagi rumah burung walet. Tata ruang yang salah atau tidak sesuai
            dengan standar kelayakan rumah burung walet akan mempersulit walet
            mengakses seluruh penjur uruangan dalam rumah walet. Misalnya ukuran
            void atau lubang terjun yang terlalu kecil akan mempersulit burung
            baru untuk terjun dan masuk ke dalam ruang inap. Lubang terjun
            minimal harus berukuran dua kali 3 meter. Permasalahan lain yang
            biasa terjadi adalah penggunaan rumah monyet yang terlalu kecil.
            Rumah monyet berfungsi untuk tempat burung putar sebelum masuk ke
            dalam ruang inap. Ukuran rumah monyet harus mengikuti luas gerakan
            walet berputar yaitu minimal 4 kali 4 meter. Alangkah baiknya rumah
            monyet memiliki luas minimal 4 kali 4 meter. Sekat di dalam ruang
            inap juga harus ditempatkan dengan sesuai jangan sampai justru
            menghalangi walet untuk mengakses seluruh ruang inap.
          </p>
        </div>
        <br />

        <div>
          <h4 className="font-bold">3. Adanya hama pengganggu</h4>
          <p>
            Rumah walet yang baik harus bebas dari hama maupun predator menjadi
            ancaman bagi walet. Kondisi ruangan dalam rumah walet harus bersih
            dari hama seperti tikus, kecoak, cicak, tokek, dll. Kondisi rumah
            walet baik dari dalam maupun di luar harus selalu dibersihkan jangan
            sampai menjadi tempat yang disenangi hama burung walet.
          </p>
        </div>
        <br />
        ...
        <p className="text-black font-bold mt-6">
          ...
          <br />
          <a
            href="https://www.dianwalet.com/2019/11/kenali-3-faktor-penghambat-perkembangan.html"
            target="_blank"
            rel="noopener noreferrer"
            className="text-iconig font-normal ml-1"
          >
            Kenali 3 Faktor Penghambat Perkembangan Rumah Burung Walet | DIAN
            WALET
          </a>
        </p>
      </div>
