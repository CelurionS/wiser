...
import M2dWallet1 from '../assets/M2wallet1.png';
...
const MateriVidPage2 = () => {
  const navigate = useNavigate(); // Initialize navigate for routing
  const [mainVideo, setMainVideo] = useState({
    title: 'Pemilihan Lokasi Rumah Walet',
    videoUrl: 'https://www.youtube.com/embed/lNiSGPE8Ang',
  ...
  const otherVideos = [
    {
      ...
      videoUrl: 'https://www.youtube.com/embed/4nKxDMm8I5U',
      Duration: '2 menit',
    },
    {
      image: M2dWallet3,
  ...
  const cardsData = [
    ...
    {
      title: 'Sistem Suara Pemanggil Walet',
      description: 'Teknik penggunaan suara pemaggil burung wallet (audio tweeter) untuk menarik burung masuk ke rumah walet, serta pemilihan jenis audio dan waktu pemutaran yang optimal',
      image: Mwallet4,
      pageUrl: '/MateriPage',
    },
  ];
